...
#计算出新的版本号
FILE_PATH_BASE=/home/gitlab-runner/apk_download/intranet
...
#NOTIFY_START_CONTENT="Android[内网]版本号：${NEW_VERSION}\n`date '+%Y-%m-%d %H:%M:%S'`开始打包啦！"
...
DOWNLOAD_URL=http://192.168.100.99/intranet/${FileName}
...
-H 'Content-Type: application/json' \
-H 'Accept: */*' \
-H 'Host: oapi.dingtalk.com' \
-d "{\"msgtype\": \"markdown\",\"markdown\": {\"title\":\"Android[内网]\",\"text\":\"${NOTIFY_CONTENT}\"}}"